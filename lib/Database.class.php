...
class Database
{
     ...
     * @throws DatabaseException
     */
    public function select($table, $select_fields = '*',$where = array(), $limit = false, $order = false, $where_mode = "AND", $group = false)
    {
        $this->result = null;
        $this->sql = null;
     ...
     * @return mixed
     */
    public function num($table = null, $where = array(), $limit = false, $order = false, $where_mode = "AND", $group = false)
    {
        if (!empty($table)) {
            $this->select($table, 'COUNT(*)', $where, $limit, $order, $where_mode, $group);
        }
     ...
     * @throws DatabaseException
     */
    function update($table, $fields = array(), $where = array(), $limit = false, $order = false, $group = false)
    {
        if (empty($where)) {
