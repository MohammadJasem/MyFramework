<nav class="navbar navbar-expand-lg navbar-dark custom-blue fixed-top" id="mainNav">
    <a class="navbar-brand" href=""><img class="logo" width="180px" height="38px" src="<?php echo e(url('img/banner.png')); ?>" /></a>
...
</nav><?php /**PATH C:\laragon\www\MyFramework\resources\views/partials/_bar.blade.php ENDPATH**/ ?>